...
def criar_usuario(usuarios):
    cpf = input("informe o CPF (somentes números): ")
    ...
    data_nascimento = input("Informe a data de nascimento (dd-mm-aaaaa): ")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\n@@@ Usuário não encontrado, fluxo de criação de conta encerradoo! @@@")
